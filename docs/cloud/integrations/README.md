...
AWS CloudWatch is a monitoring service. The "logs" portion of its functionality is separated into it's own integration in the EventStore Cloud for ease of use.
...
AWS CloudWatch is a monitoring service. The "metrics" portion of its functionality is separated into its own integration in the EventStore Cloud for ease of use.
