...
AWS CloudWatch is a monitoring service. The "logs" portion of it's functionality is seperated into it's own integration in the EventStore Cloud for ease of use.

You can cause all of the logs generated by each EventStore DB running in your clusters by creating a custom AWS CloudWatch log group, an IAM user, policy and access key and setting up an integration as described below.
...
#### Create a new AWS CloudWatch Group
...
#### Add a new AwsCloudWatchLogs integration
...
TODO ADD IMAGE
::: card
![Set your OpsGenie API Key](./images/awsCloudWatch-form.png)
:::
...
The EventStore Cloud backend may take up to 10 minutes to install new log based integrations. 
