...
Both system projections and user-defined projections produce new events. Carefully consider the impact of enabled projections on database performance. Please refer to the [Performance impact](../../server/generated/v20.10/docs/projections/README.md) section of the projections documentation to learn more.
:::
