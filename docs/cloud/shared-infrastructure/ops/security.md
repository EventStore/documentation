...
7. The certificate import process will then begin and prompt you for confirmation. Click the `Yes` button.

![Import Wizard - Step 5](images/win-import-step-5.png)

8. The import process will then complete and display the following:
