...
You can find more information about the steps needed for provisioning Kurrent Cloud resources and connecting them to your own Azure account in the [provisioning](../getting-started/private-access/aws.md) section.
