...
You can find more information about the steps needed for provisioning Kurrent Cloud resources and connecting them to your own Azure account in the [provisioning](../getting-started/dedicated-infrastructured/private_access/aws.md) section.
...
You can find more information about the steps needed for provisioning Kurrent Cloud resources and connecting them to your own GCP project in the [provisioning](../getting-started/dedicated-infrastructured/private_access/gcp.md) section.
...
You can find more information about the steps needed for provisioning Kurrent Cloud resources and connecting them to your own Azure account in the [provisioning](../getting-started/dedicated-infrastructured/private_access/azure.md) section.
...
With Azure CNI, each pod will get an IP address directly from the VNet subnet range, so all the pods will be able to reach the Kurrent Cloud resources using the peering link.
