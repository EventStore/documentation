...
::: note
The version of the EventStoreDB client above may be outdated. For more information about the client, [click here](https://developers.eventstore.com/clients/grpc/getting-started.html).
:::
...
::: info
To learn more about other EventStoreDB client functions, [click here](https://developers.eventstore.com/clients/grpc/getting-started.html).
:::
