...
By default, Auto-scavenge is bundled with KurrentDB 24.10 LTS. You can confirm its availability in the KurrentDB logs. Look for the following log message:
