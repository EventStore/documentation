...
For more information on the structure of Access Control Lists read [Access Control Lists](/server/generated/v21.2/docs/security/users-and-access-control-lists.md).
