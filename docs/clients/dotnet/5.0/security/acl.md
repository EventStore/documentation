...
For more information on the structure of Access Control Lists read [Access Control Lists](/docs/server/v5/server/security/users-and-access-control-lists.md).
