...
::: warning
Changes were not backported to the v20.10 TCP Client version. To use `Compatibility Mode` you have to upgrade to at least v21.2.0. It's fully compatible with v20.10.0. Check the details in the [TCP Compatibility Mode client v21.2 docs](../21.2/connecting.md#compatibility-mode).
:::
...
::: warning
Changes were not backported to the v20.10 TCP Client version. To use `Auto-Compatibility Mode` you have to upgrade to at least v21.2.0. It's fully compatible with v20.10.0. Check the details in the [Auto-Compatibility Mode client v21.2 docs](../21.2/connecting.md#auto-compatibility-mode).
:::
