...
<p>The code below shows how to connect to an EventStoreDB server, appends to a stream, and read back the events. For more detailed information, read the full pages for connecting to a server using <a href="#connection-string">connection string</a> and <a href="#connection-settings">connection settings</a>, <RouterLink to="/clients/dotnet/5.0/reading/">reading events</RouterLink> and <RouterLink to="/clients/dotnet/5.0/appending/">appending to a stream</RouterLink></p>
<CodeGroup>
...
<h3 id="compatibility-mode" tabindex="-1"><a class="header-anchor" href="#compatibility-mode" aria-hidden="true">#</a> Compatibility Mode</h3>
<p>Enables the client to connect to either server configuration without needing to change the client's connection settings. Read more in <a href="#compatibility-mode">Compatibility Mode documentation</a>.</p>
<table>
<thead>
<tr>
<th style="text-align:left">Builder Method</th>
...
<tbody>
<tr>
<td style="text-align:left"><code>SetCompatibilityMode(string value)</code></td>
<td style="text-align:left">Specifies if the client should run in a specific version compatibility mode. Set <code>&quot;auto&quot;</code> for Auto-Compatibility Mode or <code>&quot;20&quot;</code> for v20 Compatibility Mode</td>
</tr>
</tbody>
</table>
<h4 id="auto-compatibility-mode" tabindex="-1"><a class="header-anchor" href="#auto-compatibility-mode" aria-hidden="true">#</a> Auto-compatibility mode</h4>
...
</div><h5 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h5>
...
<h6 id="connection-string-1" tabindex="-1"><a class="header-anchor" href="#connection-string-1" aria-hidden="true">#</a> Connection string</h6>
...
<h6 id="connection-settings-1" tabindex="-1"><a class="header-anchor" href="#connection-settings-1" aria-hidden="true">#</a> Connection settings</h6>
<CodeGroup>
<CodeGroupItem title="Cluster DNS Discovery">
...
<span class="token class-name"><span class="token keyword">var</span></span> clusterSettings <span class="token operator">=</span> ClusterSettings<span class="token punctuation">.</span><span class="token function">Create</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">.</span><span class="token function">SetClusterDns</span><span class="token punctuation">(</span>dnsAddress<span class="token punctuation">)</span>
...
<span class="token class-name"><span class="token keyword">var</span></span> conn <span class="token operator">=</span> EventStoreConnection<span class="token punctuation">.</span><span class="token function">Create</span><span class="token punctuation">(</span>connectionSettings<span class="token punctuation">,</span> clusterSettings<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">await</span> conn<span class="token punctuation">.</span><span class="token function">ConnectAsync</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<CodeGroupItem title="Gossip Seeds">
<div class="language-csharp ext-cs line-numbers-mode"><pre v-pre class="language-csharp"><code><span class="token class-name"><span class="token keyword">var</span></span> connectionSettings <span class="token operator">=</span> ConnectionSettings<span class="token punctuation">.</span><span class="token function">Create</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">SetGossipSeedEndPoints</span><span class="token punctuation">(</span>
        <span class="token keyword">new</span> <span class="token constructor-invocation class-name">IPEndPoint</span><span class="token punctuation">(</span>node1<span class="token punctuation">,</span> <span class="token number">2113</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
        <span class="token keyword">new</span> <span class="token constructor-invocation class-name">IPEndPoint</span><span class="token punctuation">(</span>node2<span class="token punctuation">,</span> <span class="token number">2113</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
        <span class="token keyword">new</span> <span class="token constructor-invocation class-name">IPEndPoint</span><span class="token punctuation">(</span>node3<span class="token punctuation">,</span> <span class="token number">2113</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">SetCompatibilityMode</span><span class="token punctuation">(</span><span class="token string">"auto"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

<span class="token class-name"><span class="token keyword">var</span></span> conn <span class="token operator">=</span> EventStoreConnection<span class="token punctuation">.</span><span class="token function">Create</span><span class="token punctuation">(</span>connectionSettings<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">await</span> conn<span class="token punctuation">.</span><span class="token function">ConnectAsync</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div></CodeGroupItem>
</CodeGroup>
<h4 id="v20-compatibility-mode" tabindex="-1"><a class="header-anchor" href="#v20-compatibility-mode" aria-hidden="true">#</a> v20 compatibility mode</h4>
<p>The v20 compatibility mode allows the v5 client to connect to a cluster running in ES Cloud.</p>
<p>You can set this with <code>CompatibilityMode=20</code> in the connection string, or with <code>.SetCompatibilityMode(&quot;20&quot;)</code> in the connection settings.</p>
<p>For example:</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>ConnectTo=discover://{CloudClusterId}.mesdb.eventstore.cloud:2113?UseSslConnection=true;ValidateServer=true;CompatibilityMode=20;
