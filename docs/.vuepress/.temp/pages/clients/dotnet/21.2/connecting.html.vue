...
<p>The code below shows how to connect to an EventStoreDB server, appends to a stream, and read back the events. For more detailed information, read the full pages for connecting to a server using <a href="#connection-string">connection string</a> and <a href="#connection-settings">connection settings</a>, <RouterLink to="/clients/dotnet/21.2/reading/">reading events</RouterLink> and <RouterLink to="/clients/dotnet/21.2/appending/">appending to a stream</RouterLink></p>
<CodeGroup>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code></code></pre><div class="line-numbers"></div></div></template>
