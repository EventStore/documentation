...
<p>To configure the client-side of the SSL connection, use the builder method below. For more information on setting up the server end of the EventStoreDB for SSL, see <RouterLink to="/server/generated/v21.2/docs/security/">SSL Setup</RouterLink>.</p>
...
<h2 id="compatibility-mode" tabindex="-1"><a class="header-anchor" href="#compatibility-mode" aria-hidden="true">#</a> Compatibility Mode</h2>
<p>Enables the client to connect to either server configuration without needing to change the client's connection settings. Read more in <RouterLink to="/clients/dotnet/21.2/connecting/compatibility-mode.html">Compatibility Mode documentation</RouterLink>.</p>
<table>
<thead>
<tr>
<th style="text-align:left">Builder Method</th>
...
<td style="text-align:left">Specifies if the client should run in a specific version compatibility mode. Set <code>&quot;auto&quot;</code> for Auto-Compatibility Mode or <code>&quot;5&quot;</code> for v5 Compatibility Mode</td>
</tr>
</tbody>
</table>
...
<p>You can enable auto-compatibility mode with <code>.SetCompatibilityMode(&quot;auto&quot;)</code> in the connection settings.</p>
<h3 id="v5-compatibility-mode" tabindex="-1"><a class="header-anchor" href="#v5-compatibility-mode" aria-hidden="true">#</a> v5 Compatibility Mode</h3>
<p>The v5 Compatibility Mode allows the v21.2 client to connect to a v5 cluster.</p>
<p>You can set this with with <code>.SetCompatibilityMode(&quot;5&quot;)</code> in the connection settings.</p>
</template>
