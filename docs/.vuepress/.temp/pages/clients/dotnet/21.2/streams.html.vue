...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>This method will put the data that is in metadata as the stream metadata. Metadata in this case can be anything in a vector of bytes. The server only understands JSON. Read <RouterLink to="/clients/dotnet/21.2/security.html#access-control-lists">Access Control Lists</RouterLink> for more information on the format in JSON for access control lists.</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
