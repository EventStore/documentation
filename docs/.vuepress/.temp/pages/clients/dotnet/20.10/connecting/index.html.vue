...
<p>The code below shows how to connect to an EventStoreDB server, appends to a stream, and read back the events. For more detailed information, read the full pages for connecting to a server using <RouterLink to="/clients/dotnet/20.10/connecting/connection-string.html">connection string</RouterLink> and <RouterLink to="/clients/dotnet/20.10/connecting/settings.html">connection settings</RouterLink>, <RouterLink to="/clients/dotnet/20.10/reading/">reading events</RouterLink> and <RouterLink to="/clients/dotnet/20.10/appending/">appending to a stream</RouterLink></p>
<xode-group>
<xode-block title="JSON format event">
<p>@[code](clients/dotnet/20.10/sample-code/DotNetClient/QuickStartJsonFormat.cs</p>
</xode-block>
<xode-block title="Plain-text format event">
<p>@[code](clients/dotnet/20.10/sample-code/DotNetClient/QuickStartPlainFormat.cs</p>
</xode-block>
</xode-group>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>We recommended to use the JSON format for data and metadata.</p>
</div>
</template>
