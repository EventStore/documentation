...
<p>This page provides an example of using <RouterLink to="/server/generated/v20.10/docs/projections/#types-of-projections">user-defined projections</RouterLink> in your application.</p>
...
<ul>
<li><a href="/server/generated/v20.10/samples/http-api/data/shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1164.json">shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1164.json</a></li>
<li><a href="/server/generated/v20.10/samples/http-api/data/shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1165.json">shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1165.json</a></li>
<li><a href="/server/generated/v20.10/samples/http-api/data/shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1166.json">shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1166.json</a></li>
<li><a href="/server/generated/v20.10/samples/http-api/data/shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1167.json">shoppingCart-b989fe21-9469-4017-8d71-9820b8dd1167.json</a></li>
</ul>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ReadEventsFunction</p>
<p>Then, we can use this function and push events to EventStoreDB:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#SeedEvents</p>
...
<p>Read <RouterLink to="/server/generated/v20.10/docs/projections/user-defined-projections.html">this guide</RouterLink> to find out more about the user defined projection's API.</p>
</div>
...
<p>@[code](server/generated/v20.10/samples/http-api/xbox-one-s-counter.js</p>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ProjectionsManager
@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#CreateUserProjection</p>
<div class="custom-container tip"><p class="custom-container-title">Next steps</p>
<p><RouterLink to="/clients/dotnet/20.10/projections/projections-management.html">Read here</RouterLink> for more information on creating projections with the .NET API and the parameters available, or <RouterLink to="/server/generated/v20.10/docs/projections/">our projections section</RouterLink> for details on projection syntax.</p>
</div>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#GetProjectionState</p>
...
<p>@[code](server/generated/v20.10/samples/http-api/xbox-one-s-counter-outputState.js</p>
<p>To update the projection, edit the projection definition with the following request:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ProjectionsManager
@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#UpdateUserProjection</p>
<p>Then reset the projection you created above:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ResetUserProjection</p>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#QueryUpdatedProjection</p>
...
<p>@[code](server/generated/v20.10/samples/http-api/projections/update-projection-options.js{2}</p>
<p>Then send the update to the projection:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ProjectionsManager
@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#UpdateProjectionProperties</p>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>You can find all the options available in the <RouterLink to="/server/generated/v20.10/docs/projections/user-defined-projections.html">user defined projections guide</RouterLink>.</p>
</div>
<p>Now you can read the result as above, but use the new stream name:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ReadUpdatedProjectionStream</p>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#ProjectionsManager
@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#EnableCategoryProjection</p>
...
<p>@[code](/server/generated/v20.10/samples/http-api/projections/shopping-cart-counter.js</p>
<p>Create the projection with the following request:</p>
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#CreatePartitionedProjection</p>
...
<p>@[code](clients/dotnet/20.10/sample-code/GettingStarted/UserProjections.cs#GetPartitionedProjectionState</p>
<p>The server then returns the state for the partition:</p>
<p>@[code](/server/generated/v20.10/samples/http-api/projections/read-state-partition.json</p>
</template>
