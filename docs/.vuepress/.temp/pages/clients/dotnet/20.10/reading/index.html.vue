...
<h3 id="read-a-single-event" tabindex="-1"><a class="header-anchor" href="#read-a-single-event" aria-hidden="true">#</a> Read a single event</h3>
...
<p>@[code](clients/dotnet/20.10/sample-code/Program.cs#ReadOneEvent</p>
<h3 id="read-a-specific-stream-forwards" tabindex="-1"><a class="header-anchor" href="#read-a-specific-stream-forwards" aria-hidden="true">#</a> Read a specific stream forwards</h3>
<div class="language-csharp ext-cs line-numbers-mode"><pre v-pre class="language-csharp"><code><span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>StreamEventsSlice<span class="token punctuation">></span></span> <span class="token function">ReadStreamEventsForwardAsync</span><span class="token punctuation">(</span><span class="token class-name"><span class="token keyword">string</span></span> stream<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">long</span></span> start<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">int</span></span> count<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">bool</span></span> resolveLinkTos<span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>Bear in mind that there could be many events in the stream. The .NET client always reads events in pages with the default page size of 4096 events. If you need to read the whole stream, you'd have to keep reading pages until the response will indicate that you reached the end of the stream.</p>
...
<h3 id="read-a-specific-stream-backwards" tabindex="-1"><a class="header-anchor" href="#read-a-specific-stream-backwards" aria-hidden="true">#</a> Read a specific stream backwards</h3>
<div class="language-csharp ext-cs line-numbers-mode"><pre v-pre class="language-csharp"><code><span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>StreamEventsSlice<span class="token punctuation">></span></span> <span class="token function">ReadStreamEventsBackwardAsync</span><span class="token punctuation">(</span><span class="token class-name"><span class="token keyword">string</span></span> stream<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">long</span></span> start<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">int</span></span> count<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">bool</span></span> resolveLinkTos<span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h3 id="read-all-events-forwards" tabindex="-1"><a class="header-anchor" href="#read-all-events-forwards" aria-hidden="true">#</a> Read all events forwards</h3>
<div class="language-csharp ext-cs line-numbers-mode"><pre v-pre class="language-csharp"><code><span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>AllEventsSlice<span class="token punctuation">></span></span> <span class="token function">ReadAllEventsForwardAsync</span><span class="token punctuation">(</span><span class="token class-name">Position</span> position<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">int</span></span> maxCount<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">bool</span></span> resolveLinkTos<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h3 id="read-all-events-backwards" tabindex="-1"><a class="header-anchor" href="#read-all-events-backwards" aria-hidden="true">#</a> Read all events backwards</h3>
<div class="language-csharp ext-cs line-numbers-mode"><pre v-pre class="language-csharp"><code><span class="token return-type class-name">Task<span class="token punctuation">&lt;</span>AllEventsSlice<span class="token punctuation">></span></span> <span class="token function">ReadAllEventsBackwardAsync</span><span class="token punctuation">(</span><span class="token class-name">Position</span> position<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">int</span></span> maxCount<span class="token punctuation">,</span> <span class="token class-name"><span class="token keyword">bool</span></span> resolveLinkTos<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>These methods also have an optional parameter which allows you to specify the <code>UserCredentials</code> to use for the request. If you don't supply any, the default credentials for the <code>EventStoreConnection</code> are used (<RouterLink to="/clients/dotnet/20.10/reading/connecting-to-a-server.html#user-credentials">see Connecting to a server - user credentials</RouterLink>).</p>
</div>
<h2 id="streameventsslice" tabindex="-1"><a class="header-anchor" href="#streameventsslice" aria-hidden="true">#</a> StreamEventsSlice</h2>
...
<h2 id="read-a-single-event-1" tabindex="-1"><a class="header-anchor" href="#read-a-single-event-1" aria-hidden="true">#</a> Read a single event</h2>
...
<h2 id="reading-a-stream-forwards" tabindex="-1"><a class="header-anchor" href="#reading-a-stream-forwards" aria-hidden="true">#</a> Reading a stream forwards</h2>
...
<h3 id="example-read-all-events-forward-from-start-to-end" tabindex="-1"><a class="header-anchor" href="#example-read-all-events-forward-from-start-to-end" aria-hidden="true">#</a> Example: Read all events forward from start to end</h3>
