...
<<< @/docs/server/sample-code/getting-started/docker-compose.yaml
...
Get on the fast-track with [a native SDK for your language of choice](which-api-sdk.md).
...
<<< @/docs/clients/dotnet/sample-code/Program.cs#using
...
<<< @/docs/server/sample-code/EventStore.Samples.Java/pom.xml#dependency
...
:::: el-tabs
::: el-tab-pane label=".NET client"
<<< @/docs/clients/dotnet/sample-code/GettingStarted/Connection.cs#connect
:::
::: el-tab-pane label="JVM client"
<<< @/docs/server/sample-code/EventStore.Samples.Java/src/main/java/org/eventstore/sample/WriteEventExample.java#connection
...
<<< @/docs/server/sample-code/getting-started/event.json
...
<<< @/docs/server/sample-code/getting-started/write-event.sh#curl
...
::: tip Next steps
Read [this guide](/docs/clients/http/5.0.8/creating-writing-a-stream.md) for more information on how to write events with the HTTP API.
:::
...
<<< @/docs/clients/dotnet/sample-code/GettingStarted/ConnectEventStore.cs#appendEvent

::: tip Next steps
Read [this guide](http://missing) for more information on how to write events with the .NET API. We don't cover version checking in this guide, but you can read more in [the optimistic concurrency guide](/docs/clients/dotnet/5.0.8/optimistic-concurrency-and-idempotence.md).
:::
...
<<< @/docs/server/sample-code/EventStore.Samples.Java/src/main/java/org/eventstore/sample/WriteEventExample.java#writeResult
<<< @/docs/server/sample-code/EventStore.Samples.Java/src/main/java/org/eventstore/sample/WriteEventExample.java#writeEvent
...
-   [Step 2 - Read events from a stream and subscribe to changes](reading-subscribing-events.md)
