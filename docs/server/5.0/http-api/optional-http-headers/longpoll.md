...
:::: tabs
::: tab Request
<<< @/docs/server/5.0/http-api/sample-code/get-forward-link.sh#curl
:::
::: tab Response
<<< @/docs/server/5.0/http-api/sample-code/get-forward-link.sh#response
:::
::::

The entries section is empty (there is no further data to provide). Now try the same URI with a long poll header.

<<< @/docs/server/5.0/http-api/sample-code/longpoll.sh
